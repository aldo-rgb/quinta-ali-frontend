                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <input type="number" min="1" value={b2bForm.num_empleados} onChange={e => setB2bForm(p => ({ ...p, num_empleados: e.target.value, num_asistentes: e.target.value }))} className="w-full p-3 border border-gray-200 rounded-xl text-sm focus:ring-primary focus:border-primary" placeholder="50-100" />
                      </div>
                    </div>
                    <div>
